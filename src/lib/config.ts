...
export const DIFY_URL = process.env.DIFY_URL || 'https://api.dify.ai/v1/chat-messages';
...
if (!DIFY_API_KEY) {
  console.warn('Warning: DIFY_API_KEY is not set. AI disambiguation will not work.');
}
